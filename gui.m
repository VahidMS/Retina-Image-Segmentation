...
% Last Modified by GUIDE v2.5 26-Jan-2020 15:13:09
...
function imgnum=imgnum_Callback(hObject, eventdata, handles)
...
function pushbutton1_Callback(hObject, eventdata, handles)
   imgnum = str2num(get(handles.imgnum,'String'))
   Evaluation_LineKMeans
...
% --- Otherwise, executes on mouse press in 5 pixel border or over imgnum.
function imgnum_ButtonDownFcn(hObject, eventdata, handles)
% hObject    handle to imgnum (see GCBO)
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
